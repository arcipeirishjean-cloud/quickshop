...
Preview URL: https://demo.templatesjungle.com/kaira/  # original demo (template provider)

This copy has been renamed locally to "QuickShop" for branding and testing.
